      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            <img src="/siddhi-logo.jpeg" alt="Siddhi's Coaching" width={40} height={40} loading="lazy" className="w-10 h-10 rounded-lg object-cover" />
            <div>
          ...
          <div className="flex gap-3 mt-5">
            {/* Instagram — only live social profile. Re-add Facebook/YouTube here
                once real profile URLs exist (dead href="#" links hurt UX + SEO). */}
